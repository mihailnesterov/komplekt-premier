...
if ( ! class_exists( 'Storefront' ) ) :
	...
	class Storefront {
		...
		public function scripts() {
          ...
          // Mihail add 30.09.2019
            wp_enqueue_style( 'custom-style', get_template_directory_uri() . '/assets/css/custom.css', array('storefront-style','sfb-styles','shm-styles','storefront-woocommerce-style','custom-css'), null );
          ...
          // Mihail add 30.09.2019
          	wp_enqueue_script( 'jquery-341',  get_template_directory_uri() . '/assets/js/vendor/jquery/jquery.min.js', array('jquery'), '3.4.1', true );
         	wp_enqueue_script( 'custom-script', get_template_directory_uri() . '/assets/js/custom.js', array('jquery-341'), '20190930', true );
