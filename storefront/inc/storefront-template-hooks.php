...
add_action( 'storefront_header', 'additional_site_search_top',                  20 );	/* mihail add 04.04.19 */
...
add_action( 'homepage', 'storefront_homepage_slider',       10 );
add_action( 'homepage', 'storefront_product_categories',    20 );
add_action( 'homepage', 'storefront_new_products',       30 );
add_action( 'homepage', 'storefront_our_advantages',        35 );
...
add_action( 'homepage', 'storefront_bottom_contact', 80 );
add_action( 'homepage', 'storefront_our_clients', 90 );
